...
<?php include 'php/edit_user_server.php'; ?>
        ...
        <div class="page-container3">
            <section>
                <div class="container"><br>
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">EDIT USER</h3>
                        <?php
                        if (isset($msg)) { ?>
                 ...
                 <?php 
                        $userId = $_GET['user'];
                        $qry = $db->prepare("SELECT users.*, ranks.rank, ranks.id AS rid FROM users JOIN ranks ON ranks.id=users.rank WHERE users.id = '{$userId}'");
                        $qry->execute();
                                  ...
                                  <div class="card-body card-block">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" id="username" class="au-input au-input--full" value="<?php echo($result->username) ?>" required  autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       ...
                                       <select name="rank" id="rank" class="form-control" required>
                                        <option value="<?php echo htmlentities($rank_id=$result->rid);?>"><?php echo htmlentities($result->rank);?></option>
                                        <?php 
                                        $ret=$db->query("SELECT * FROM ranks");
                                        $row_data = $ret->fetchAll(PDO::FETCH_OBJ);
                                         foreach($row_data as $data){
                                        $rank_id_2= $data->id;
                                        if($rank_id==$rank_id_2)
                                        {
                                            continue;
                                        }
                                        else{
                                        ?>
                                        <option value="<?php echo $data->id;?>"><?php echo  $data->rank;?></option>
                                        <?php } }?>
                                        </select>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="editUserBtn" class="btn btn-primary btn-xl">
