...
<?php include 'php/add_inmate_server.php'; ?>
                  ...
                  <div class="card">
                    ...
                    <form action="" method="post" id="inmate-form" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="au-input au-input--full" name="code" id="code" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="au-input au-input--full" name="firstname" id="firstname" required="required">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="middlename" class="control-label">Middle Name</label>
                                    <input type="text" class="au-input au-input--full" name="middlename" id="middlename" placeholder="optional">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="lastname" class="control-label">Last Name</label>
                                    <input type="text" class="au-input au-input--full" name="lastname" id="lastname" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="au-input au-input--full" name="dob" id="dob" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="2" class="form-control" name="address" id="address" required="required"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="complexion" class="au-input au-input--full" name="complexion" id="complexion" required="required">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="eye_color" class="control-label">Eye Color</label>
                                    <input type="text" class="au-input au-input--full" name="eye_color" id="eye_color" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="sentence" class="au-input au-input--full" name="sentence" id="sentence" required="required">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="au-input au-input--full" name="date_from" id="date_from" required="required">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="date_to" class="control-label">Time Serve Ends</label>
                                        <input type="date" class="au-input au-input--full" name="date_to" id="date_to">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="emergency_name" class="au-input au-input--full" name="emergency_name" id="emergency_name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="au-input au-input--full" name="emergency_relation" id="emergency_relation">
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label for="emergency_contact" class="control-label">Contact #</label>
                                        <input type="text" class="au-input au-input--full" name="emergency_contact" id="emergency_contact">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <div class="card-footer">
                                        <button type="submit" name="addInmateInfoBtn" class="btn btn-primary btn-xl">
