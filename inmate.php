...
<?php include 'php/delete_inmate_server.php'; ?>
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">INMATE LIST</h3>
                        <?php
                        if (isset($msg)) { ?>
                         ...
                         <?php } ?>
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a href="add-inmate.php" class="au-btn au-btn-icon au-btn--green au-btn--small" >
                                            <i class="zmdi zmdi-plus"></i>add inmate</a>
                                ...
                                <div class="">
                                    <table class="table table-striped" id="prison_table" style="width:100%">
                                        ...
                                        <tbody>
                                         <?php 
                    $i = 1;
                        $qry = $db->prepare("SELECT *,concat(lastname,' ', firstname, coalesce(concat(' ', middlename), '')) AS `name` FROM `inmate_list` WHERE delete_flag=0 ORDER BY `name` ASC");
                        $qry->execute();
                                                ...
                                                <td align="center">
                                                 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                                                  ...
                                                  <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item view-data" href="view-inmate.php?view_inmate&id=<?php echo $result->id; ?>"><span class="fa fa-eye text-dark"></span> View</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item edit-data" href="edit-inmate.php?id=<?php echo $result->id; ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
                                                <?php 
                                                  if ($_SESSION['type'] == 1) { ?>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item delete_data" href="inmate.php?inm_id=<?php echo $result->id; ?>" onclick="return confirm('Are you sure you want to delete this Inmate?')"><span class="fa fa-trash text-danger"></span> Delete</a>
                                                    <?php }else{} ?>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDIT CELL</h5>
              ...
              <div class="modal-body">
                <form action="" method="post">
                    <input type="hidden" name="cell_id" value="<?php echo $result->id; ?>">
                    <div class="col-12 col-md-12">
                        ...
                        <select name="prison_name" id="prison_name" class="form-control">
                            <option value="<?php echo htmlentities($result->pr_id);?>"><?php echo htmlentities($result->prison);?></option>
                            <?php 
                    ...
                    <div class="col-12 col-md-12">
                        ...
                        <input type="text" id="cell_name" name="cell_name" value="<?php echo $result->name; ?>" placeholder="Prison Name"  class="form-control">
                    </div><br>
                    <div class="col-12 col-md-12">
                ...
                <button type="submit" name="EditCellBtn" class="btn btn-primary">Save changes</button>
              </div>
                </form>
              </div>
